  ...
  <>
    ...
    <section className="bg-background py-14">
      <div className="mx-auto max-w-3xl px-4 lg:px-6 prose prose-neutral">
        ...
        <p>By submitting your phone number through any form on this website, you consent to receiving text messages and phone calls from {client.companyName} regarding your inquiry. Message and data rates may apply. You may opt out at any time by replying STOP.</p>

        <h2>6. Limitation of Liability</h2>
        <p>{client.companyName} shall not be liable for any indirect, incidental, or consequential damages arising from the use of this website or our services beyond the amount paid for the specific service rendered.</p>

        <h2>7. Contact</h2>
        <p>For questions about these terms, contact us at <a href={`mailto:${client.email}`} className="text-accent">{client.email}</a> or call <a href={`tel:${client.phoneTel}`} className="text-accent">{client.phone}</a>.</p>
      </div>
    </section>
  </>
);
